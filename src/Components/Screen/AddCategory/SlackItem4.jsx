...
const StackItem4 = ({ item }) => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const radioCollection = collection(firestore, "VideoBannersCollection");
      ...
      if (RowID) {
        ...
        docRef = doc(firestore, "VideoBannersCollection", RowID);
